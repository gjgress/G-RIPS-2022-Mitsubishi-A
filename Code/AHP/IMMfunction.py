...
# return the index of the highest weight edge
def IMMfunc(dist_data, dir_data, map_environment):
    ...
    Z = np.array([[0.0806, 0.372],
                  [0.4376, 0.4642],
                  [0.5563, 0.4237]])

    # total weight
    TW = weight_dist * Z[map_environment][0] + weight_dir * Z[map_environment][1]
